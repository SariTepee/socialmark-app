<template>
  <aside
    class="flex flex-shrink-0 flex-col h-[100vh] bg-white w-60 border-gray-200 border-r-[1px]"
  >
    <router-link :to="{ name: 'LikesPage' }" class="sidebar-item" href="#">
      <svg
    ...
    <a class="sidebar-item" href="#/favorites">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        class="fill-current mr-2"
        height="24"
